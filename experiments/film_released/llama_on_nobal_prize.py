...
if __name__ == '__main__':
    ...
    model_size = '13b'
    # key = 'where_question'
    # output_key = "where_answer"
    key = 'where_question_actually'
    output_key = "where_answer_actually"
    model_name = "llama2-{}-chat".format(model_size)
    model_name_or_path = model_name_mapping[model_name]
    # result_file = '/home/zhuoran/hongbang/projects/HalluInducing/results/film_released/{}_on_film_release_dataset.json'.format(model_name)
    result_file = '/home/zhuoran/hongbang/projects/HalluInducing/results/film_released/{}_on_film_noble_prize_{}.json'.format(model_name,key)
    ...
    nobal_prize_dataset = CustomDataset(samples, key)

    # Initialize the DataLoader with your dataset
    data_loader = DataLoader(nobal_prize_dataset, batch_size=batch_size)
