...
if __name__ == '__main__':
    ...
    for question_num in [1,2,3,4]:
        ...
        result_dir = f'/home/zhuoran/hongbang/projects/HalluInducing/results/causal_trace/path_patch/Movies/more_fps/head_contributions_13b/question_{question_num}'
        if question_num == 4:
            result_dir += '_batch'
