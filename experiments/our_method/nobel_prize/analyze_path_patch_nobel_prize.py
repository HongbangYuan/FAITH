...
if __name__ == '__main__':
    ...
    for question_num in [1,2,3,4]:
        print(f"--------------------question_num_{question_num}------------------")
        result_dir = f'/home/zhuoran/hongbang/projects/HalluInducing/results/causal_trace/path_patch/NobelPrize/more_fps/head_contributions_13b/question_{question_num}'
        if question_num == 1:
            result_dir = f'/home/zhuoran/hongbang/projects/HalluInducing/results/causal_trace/path_patch/NobelPrize/head_contributions_13b'
        ...
        print(f"Selected top {len(selected_heads)} important heads:")
