...
if __name__ == '__main__':
    ...
    result_dir = f'{base_dir}/results/uncertainty/heads_selection/knockout/NobelPrize/{model_size}b'
    ...
    for i, sample in enumerate(samples):
        ...
        print("Debug Usage")
        # print(f"Base Uncertainty Score:{base_uncertainty_score}")
        # print(f"Current Uncertainty Score:{curr_uncertainty_score}")
