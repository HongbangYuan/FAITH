...
if __name__ == '__main__':
    ...
    score_threshold = 0.1
    all_heads_score_file = f'{result_dir}/all_heads_score_with_threshold_{score_threshold}_knockout.pkl'
    ...
    if not os.path.isfile(all_heads_score_file):
        ...
        for i, sample in enumerate(tqdm(samples)):
            ...
            for head_pos in tqdm(heads_pos,leave=False):
                ...
                curr_uncertainty_score = selector.cal_knock_out_attn_generation_with_single_head(
