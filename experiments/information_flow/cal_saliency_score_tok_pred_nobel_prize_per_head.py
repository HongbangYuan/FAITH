...
if __name__ == '__main__':
    ...
    for idx, sample in enumerate(tqdm(samples)):
        ...
        scores = np.abs(pached_states_npy * pached_states_grad_npy) # (num_layers,num_heads,query_length,query_length)

        false_object_range = find_token_range(tokenizer, truncated_generation, str(false_year))
        false_object_score = scores[:,:,-1,false_object_range[0]:false_object_range[1]].mean(axis=-1)
        # print("Debug Usage")
        ...
        result = {
            ...
            "false_object_score": false_object_score,
