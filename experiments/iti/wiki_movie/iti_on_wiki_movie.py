...
if __name__ == '__main__':
    ...
    result_dir = f'{base_dir}/results/iti/Movies/{model_size}/update_trainset'
    ...
    input_keys = ['fp_question_1','fp_question_2','fp_question_3','fp_question_4']
    ...
    for input_key,answer_key,answer_eval_key in zip(input_keys,answer_keys,answer_eval_keys):
        acc = cal_acc_wiki_movies(samples,answer_key,answer_eval_key)
