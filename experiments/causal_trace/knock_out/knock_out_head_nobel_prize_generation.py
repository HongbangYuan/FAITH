...
if __name__ == '__main__':
    ...
    result_dir = f'{base_dir}/results/causal_trace/knockout/NobelPrize'
    ...
    order_tag = "".join([str(i) for i in order])
    result_file = f'{result_dir}/{model_name}_on_nobel_prize_knock_out_heads_{order_tag}.json'
