...
if __name__ == '__main__':
    ...
    from experiments.causal_trace.sing_tok_pred_books import format_answer_from_sample
    import argparse
    ...
    result_dir = f'{base_dir}/results/causal_trace/path_patch/Books/head_contributions_{model_size}'
    result_figs_dir = f'{result_dir}/figs'
    assert os.path.exists(result_figs_dir)
    assert os.path.exists(result_dir)

    dataset_file = f'{base_dir}/results/causal_trace/tok_pred/Books/llama2-{model_size}-chat_on_books_when_fp_question2_token_answer.json'
    ...
    for i,sample in enumerate(samples):
        ...
        if not os.path.isfile(filename):
            ...
            question_counter_factual = f"When was the book {sample[subject_key]} written by XXXX?"
