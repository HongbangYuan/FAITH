...
if __name__ == '__main__':
    ...
    input_keys = ['false_premise_question']
    ...
    for input_key,output_key in zip(input_keys,output_keys):
        result_file = f"/home/zhuoran/hongbang/projects/HalluInducing/results/attention/iti/film_release/{model_name}-iti_on_film_release_{input_key}.json"
        ...
        with torch.no_grad():
            ...
            for batch in tqdm(data_loader):
                prompts = list(map(lambda x: format_question(x, instruction=""), batch[input_key]))
