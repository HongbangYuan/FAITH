...
if __name__ == '__main__':
    ...
    for input_key,output_key in zip(input_keys,output_keys):
        result_file = f"/home/zhuoran/hongbang/projects/HalluInducing/results/attention/iti/oscar/{model_name}-iti_on_film_release_{input_key}.json"
