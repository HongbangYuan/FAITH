...
if __name__ == '__main__':
    ...
    with TraceDict(model, HEADS, retain_output=True, retain_input=True, clone=True, detach=True) as ret:
        generate_ids = model.generate(inputs.input_ids, max_new_tokens=21, output_attentions=True, use_cache=False)
    ...
    plot_attention(word_attention,word_list,title=question)
    print(remove_prompt(result))
