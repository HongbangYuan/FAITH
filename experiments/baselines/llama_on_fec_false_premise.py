...
if __name__ == '__main__':
    ...
    from utils import model_name_mapping, select, CustomDataset, write_to_json, read_json
    ...
    result_file = '/home/zhuoran/hongbang/projects/HalluInducing/results/baselines/FEC/{}_false_premise_questions_answers.json'.format(model_name)

    print("model_name:", model_name_or_path)
    print("result file:", result_file)

    # samples = load_fec()
    samples = read_json('/home/zhuoran/hongbang/projects/HalluInducing/results/baselines/FEC/llama2-13b-chat_false_premise_questions.json')
